...
load("C:\\Users\\manue\\Desktop\\Tesi\\HF local data\\HF_orig.RData")
...
write.csv2(comorb_patient_level,
           "C:\\Users\\manue\\Desktop\\Tesi\\HF local data\\msc.csv",
           row.names = FALSE,
           fileEncoding = "UTF-8")
...
write.csv2(new,
           "C:\\Users\\manue\\Desktop\\Tesi\\HF local data\\dataset_ricoveri_encode_index.csv",
           row.names = FALSE,
           fileEncoding = "UTF-8")
